...
<ResponseField name="versions" type="string[]">
  ...
  <img
    ...
    src="/docs/img/version-dropdown-light.png"
  />
  <img
    class="hidden h-8 dark:block"
    src="/docs/img/version-dropdown-dark.png"
  />
</ResponseField>

<ResponseField name="anchors" type="Anchor[]">
  An array of the anchors, includes the `icon`, `color`, and `url`.
  <img class="block h-32 dark:hidden" src="/docs/img/anchor/light.png" />
  <img class="hidden h-32 dark:block" src="/docs/img/anchor/dark.png" />
...
<ResponseField name="api" type="API">
  ...
  <Expandable title="API">
    <ResponseField name="baseUrl" type="string">
      The base url for all API endpoints. If `apiBase` is an array, it will enable for multiple base url
