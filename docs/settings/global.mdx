...
<ResponseField name="topbarCta" type="Call to Action">
...
<ResponseField name="anchors" type="Anchor[]">
  ...
  <img class="block h-32 dark:hidden" src="https://mintlify-assets.b-cdn.net/anchor-light.png" />
  <img class="hidden h-32 dark:block" src="https://mintlify-assets.b-cdn.net/anchor-dark.png" />
...
<ResponseField name="api" type="API">
  Configuration for API settings. Learn more about API pages at [API Components](/api-components/playground).
