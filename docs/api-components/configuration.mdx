...
Setting the `api` field in the page's metadata will enable the [API playground](/api-components/playground).
...
<Snippet file="api-components/openapi.mdx" />

Learn more at the [OpenAPI guide](/api-components/openapi).
