...
api: "GET https://docs.mintlify.com/api/v1/demo"
hideApiMarker: true
---
...
If you have `baseUrl` configured in [mint.json](/settings/customization), you can use relative paths like `/v1/endpoint`.
