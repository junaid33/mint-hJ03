...
export const getConfigPath = async (contentDirectoryPath: string): Promise<string | null> => {
...
// TODO: Put in prebuild package
export const getConfigObj = async (contentDirectoryPath: string): Promise<any> => {
