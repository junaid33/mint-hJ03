...
export function ThemeToggle() {
  ...
  return (
    ...
    >
      ...
      <span
        aria-hidden="true"
        className="translate-x-0 dark:translate-x-3 border border-yellow-300 bg-background-light dark:border-indigo-300 dark:bg-background-dark p-[3px] pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white ring-0 transition-transform duration-200 ease-in-out"
      >
        <SunIcon />
        <MoonIcon />
      </span>
