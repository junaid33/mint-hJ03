    ...
    return (
      <li>
        <Link
          href={button.url ?? '/'}
          target="_blank"
          className="relative inline-flex items-center space-x-2 px-4 py-1.5 shadow-sm text-sm font-medium rounded-full text-white bg-primary-dark hover:opacity-[0.85]"
        >
